...
OpenLayers.Util.OSM.MISSING_TILE_URL = "http://a.tile.openstreetmap.org/${z}/${x}/${y}.png";
/**
...
OpenLayers.Layer.OSM.Mapnik = OpenLayers.Class(OpenLayers.Layer.OSM, {
    ...
    initialize: function(name, options) {
        var url = ["http://cassini.toolserver.org/tiles/osm-like/eu/${z}/${x}/${y}.png", "http://a.tile.openstreetmap.org/${z}/${x}/${y}.png"];
