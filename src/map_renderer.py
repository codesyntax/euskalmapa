...
if __name__ == "__main__":
    path = "../templates/osm.xml"
    if not os.path.exists(path):
        path = os.environ.get('MAPNIK_MAP_FILE', '')
    
    mapfile = path
    map_uri = "../tiles/image.png"

    #---------------------------------------------------
    #  Change this to the bounding box you want
    #
    ll = (-2.190999984741211,43.27526814311737,-2.145509719848633,43.293012896897345)#(-6.5, 49.5, 2.1, 59)
    #---------------------------------------------------
